...
struct FPerlinNoiseVariables
{
	...
	UPROPERTY( EditAnywhere, meta = (ClampMin = "0.0", ClampMax="100000.0", Step = "1.0", Units="cm") )
	float Frequency;
	
	UPROPERTY(EditAnywhere, meta = (ClampMin = "0.0", ClampMax = "10000.0", Step = "1.0", Units="cm") )
